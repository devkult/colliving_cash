...
async def test() -> None:
    ...
    resident_res2, *_ = await mediator.handle_command(JoinRoomCommand(user_res.oid, room_res.oid))
    resident_res2, *_ = await mediator.handle_command(JoinRoomCommand('ываы', room_res.oid))
